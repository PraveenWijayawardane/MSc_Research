...
def main():
    print("Setting up OpenSearch Dashboards objects...")

    # 1. Risk Classification Count (Pie Chart)
    vis_1_id = "de2ca5b0-83a0-11f1-a9b6-45089fa870e0"
    vis_1_state = {
    ...
    create_saved_object("visualization", vis_1_id, {
        "title": "Risk Classification Count",
    ...
    vis_2_id = "74dd0090-83a1-11f1-a9b6-45089fa870e0"
    vis_2_state = {
    ...
    create_saved_object("visualization", vis_2_id, {
        "title": "Detection Type Count",
    ...
    vis_3_id = "d10783e0-83a1-11f1-a9b6-45089fa870e0"
    vis_3_state = {
    ...
    create_saved_object("visualization", vis_3_id, {
        "title": "Risk Score Over Time",
    ...
    vis_4_id = "6e2ab7f0-83a2-11f1-a9b6-45089fa870e0"
    vis_4_state = {
    ...
    create_saved_object("visualization", vis_4_id, {
        "title": "Top Risky Source Hosts",
    ...
    vis_5_id = "4b312330-83a5-11f1-a9b6-45089fa870e0"
    vis_5_state = {
    ...
    create_saved_object("visualization", vis_5_id, {
        "title": "Top Destination Ports",
    ...
    vis_6_id = "8a7f1010-83aa-11f1-a9b6-45089fa870e0"
    fields_vis_6 = [
        ("@timestamp", "@timestamp"),
    ...
    create_saved_object("visualization", vis_6_id, {
        "title": "High Risk Event Details",
    ...
    vis_7_id = "9b8f2020-83aa-11f1-a9b6-45089fa870e0"
    fields_vis_7 = [
        ("@timestamp", "@timestamp"),
        ("source_host.keyword", "source_host"),
        ("source_ip.keyword", "source_ip"),
    ...
    create_saved_object("visualization", vis_7_id, {
        "title": "Correlated Host Network Events",
    ...
    # 8. Final Dashboard Creation
    vis_ids = [
        ("0", vis_1_id, 0, 0, 16, 12),     # Top row left: Risk Classification Count
        ("1", vis_2_id, 16, 0, 16, 12),    # Top row middle: Detection Type Count
        ("2", vis_5_id, 32, 0, 16, 12),    # Top row right: Top Destination Ports
        ("3", vis_3_id, 0, 12, 48, 12),    # Middle row: Risk Score Over Time
        ("4", vis_4_id, 0, 24, 16, 15),    # Bottom row left: Top Risky Source Hosts
        ("5", vis_6_id, 16, 24, 16, 15),   # Bottom row middle: High Risk Event Details
        ("6", vis_7_id, 32, 24, 16, 15)    # Bottom row right: Correlated Host Network Events
    ]

    panels = []
    references = []

    for panel_idx, vis_id, x, y, w, h in vis_ids:
